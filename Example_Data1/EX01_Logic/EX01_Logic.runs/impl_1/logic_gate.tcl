...
set rc [catch {
  ...
  set_property webtalk.parent_dir E:/Example/XExample/EX01_Logic/EX01_Logic.cache/wt [current_project]
  set_property parent.project_path E:/Example/XExample/EX01_Logic/EX01_Logic.xpr [current_project]
  set_property ip_output_repo E:/Example/XExample/EX01_Logic/EX01_Logic.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
  add_files -quiet E:/Example/XExample/EX01_Logic/EX01_Logic.runs/synth_1/logic_gate.dcp
  read_xdc E:/Example/XExample/EX01_Logic/logic_gate.xdc
  link_design -top logic_gate -part xc7s6ftgb196-1
...
set rc [catch {
  ...
  create_report "impl_1_route_report_timing_summary_0" "report_timing_summary -max_paths 10 -file logic_gate_timing_summary_routed.rpt -pb logic_gate_timing_summary_routed.pb -rpx logic_gate_timing_summary_routed.rpx -warn_on_violation "
...
set rc [catch {
  ...
  catch { write_mem_info -force logic_gate.mmi }
