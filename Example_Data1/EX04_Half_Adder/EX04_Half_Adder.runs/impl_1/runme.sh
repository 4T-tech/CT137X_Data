...
HD_PWD='E:/Example/XExample/EX04_Half_Adder/EX04_Half_Adder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log half.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source half.tcl -notrace
