...
HD_PWD='E:/Example/XExample/EX04_Half_Adder/EX04_Half_Adder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log half.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source half.tcl
