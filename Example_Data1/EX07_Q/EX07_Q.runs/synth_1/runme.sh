...
HD_PWD='E:/Example/XExample/EX07_Q/EX07_Q.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log q_8.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source q_8.tcl
