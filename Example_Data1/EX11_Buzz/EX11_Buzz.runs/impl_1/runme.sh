...
HD_PWD='E:/Example/XExample/EX11_Buzz/EX11_Buzz.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log buzz.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source buzz.tcl -notrace
