...
HD_PWD='E:/Example/XExample/EX11_Buzz/EX11_Buzz.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log buzz.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source buzz.tcl
