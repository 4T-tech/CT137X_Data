...
HD_PWD='E:/Example/XExample/EX07_Q/EX07_Q.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log q_8.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source q_8.tcl -notrace
