...
HD_PWD='E:/Example/XExample/EX09_Led_Breath/EX09_Led_Breath.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log led_breath.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source led_breath.tcl -notrace
