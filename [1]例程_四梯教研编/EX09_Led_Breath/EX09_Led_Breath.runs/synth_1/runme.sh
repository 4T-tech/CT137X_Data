...
HD_PWD='E:/Example/XExample/EX09_Led_Breath/EX09_Led_Breath.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log led_breath.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source led_breath.tcl
